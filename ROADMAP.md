...
> **시리즈 의도** — Samhan Public 핵심 가치 = "두 사람이 같은 전표 보고 한 명 코멘트 → 다른 사람에게 실시간 반영". 4 슬라이스 (PR-H1 ~ PR-H4) 단계 진입. **PR-H1 (PR #123) + PR-H2 (PR #124) + PR-H3 (PR #125) + PR-H4a (PR #126, 시리즈 1~4 분할 1/3) 머지 완료 + 본 PR-H4b 진행 (시리즈 4 분할 2/3 = BE 13 service 일괄 `shared/realtime-abstraction` 적용 + 도메인별 specialization). PR-H4 시리즈 분할 = H4a (shared module) → H4b (BE 13 service 일괄) → H4c (FE 50+ page 통합).**
