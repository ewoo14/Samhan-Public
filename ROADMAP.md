...
> **시리즈 의도** — Samhan Public 핵심 가치 = "두 사람이 같은 전표 보고 한 명 코멘트 → 다른 사람에게 실시간 반영". 4 슬라이스 (PR-H1 ~ PR-H4) 단계 진입. **PR-H1 (PR #123) + PR-H2 (PR #124) 머지 완료 (시리즈 1~2/4) + 본 PR-H3 진행 (시리즈 3/4 = slip 수정/삭제 요청 워크플로우 + 잠금 가드).**
...
### 진입 plan
- 본 PR-H3 머지 후 **PR-H4 (전 15 service + 50+ page audit+sync+권한 일괄 확장, ~7주)** 즉시 진입. partner / inventory / accounting / arologis / dashboard 등 14 backend MSA 도메인 모두 SSE 채널 도입 + `shared/realtime` module 추출 + 본 PR-H2 시드 `RedisRealtimeBroker` config toggle 활성 (다중 노드 진입 시).
