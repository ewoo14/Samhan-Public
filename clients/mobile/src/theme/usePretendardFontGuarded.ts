 ...
 *
 * 본 mobile (v4) 는 100% WebView wrapper — RN native Text/View 가 사실상 0개.
 * UI 의 폰트는 WebView 안 legacy order-app 의 Pretendard web font (`<link>`) 가 결정한다.
 *
 ...
 *  - `clients/mobile/package.json` 에 `expo-font` 추가 + `assets/fonts/Pretendard-*.otf`
