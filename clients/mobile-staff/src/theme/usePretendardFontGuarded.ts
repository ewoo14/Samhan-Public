 ...
 *   - `clients/mobile-staff/assets/fonts/Pretendard-*.otf` 9 weight 배치
 *   - `expo-font` 의존성 정식 추가
 *
 * 동작:
 ...
 *     미적용해도 무영향.
 *   - 본 PR (W10-3) driver tab 의 RN native UI (Dashboard / LocationTracking / Signature) 는 등록된
...
/**
 * Pretendard 9 weight 파일명 매핑 — 사용자 결정 5 (W3+W4+W5+post-W5+W10-1 토큰 1:1 복제) 일관.
 *
 * 본 PR (W10-3) 시점 self-host:
 ...
 * 본 PR 진입 시점 OTF 미배치 가능성 (asset bundle 부담) → graceful guard 우선, 후속 슬라이스에서 OTF 정식 배치.
 */
