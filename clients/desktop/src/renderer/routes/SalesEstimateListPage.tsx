 ...
 *
 * <p>[Phase 6 v4] 신규 견적 작성 버튼은 legacy estimate index.html (18614 라인) 을 그대로
 * 임베드한 webview 화면 (`/sales/estimates/legacy`) 으로 진입한다. legacy 시각/기능 100%
 * 일치 + shim (window.google.script.run → samhanApi) 으로 backend 호환.</p>
 *
 * <p>UUID 비공개 가드 — 사용자 노출 식별자는 estimateNumber / partnerName 만.</p>
 */
...
// v2 §정정 8 — 'YYYY/MM/DD' 통일 양식.
const ymd = (iso: string) => formatSlipDate(iso)
