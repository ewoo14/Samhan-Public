...
function lineMap(lines: FundsFlowCounterAccountLine[]): Map<string, FundsFlowCounterAccountLine> {
...
function buildRows(data: FundsFlowComparisonResponse | undefined): FlowTableRow[] {
  if (!data) return []
  return [
    {
      key: 'opening',
