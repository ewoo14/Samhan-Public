...
## 🟢 현재 상태 (2026-06-17 최신) — 기초품목↔견적품목 분리 에픽: **슬1(견적품목 관리 메뉴) 머지 완료(#496)** → 🔄 슬2(세트구성+구성품정렬+옵션 이관) 착수. ※딥리서치 2건: NTS 전자세금계산서(ASP 권고·완료, `docs/research/2026-06-17-etax-invoice-nts-vs-asp.md`) + 법인계좌 입출금 실시간 연동(진행 중)
