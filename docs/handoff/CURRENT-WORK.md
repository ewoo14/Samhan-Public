...
### 실행 순서 (PM 자율)
1. 회계체인: **#823 ✅ 머지 완료**(main `3fee4b699`·PR #849)→**전표 거래처 필수화(전이 가드·결정완료) ◀ 다음 착수**→**#825 슬5**  2. #825 슬6(쪽지칩)·슬7(주문병합)  3. **#845 DS-3**→DS-4  4. #824(품목 VAT)·**#848 ✅ 머지 완료**(main `0c8210df0`·PR #852)  5. chore 배치(#831·#832·#838·#839·#828)  6. AC 후속(#834·836·837·840·842·843)  7. 🔴 **Google 자격 후** #827·#773  8. Phase11 #830 · cutover-defer #826
...
>
> **✅ 전표 거래처 필수화 결정 완료(전이 가드)** — 회계체인 #823 다음 슬라이스로 #848 완료 후 착수. 구 🔴 "개발책임자 재확인" 해소(AskUserQuestion 확정).
