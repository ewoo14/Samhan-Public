...
| 주차 | 산출물 |
|---|---|
| W1 | partner-service skeleton + 환경변수 + IT |
| W2 | groupware-service skeleton (결재선 도메인 모델 + 메신저 entity) |
| W3 | notification-service skeleton (push/email/sms adapter) |
| W4 | dashboard-service skeleton (실시간 KPI 집계 + materialized view) |
...
- 누적 결정: `migration/decisions/DECISIONS.md` (D-P9-01 ~ D-P9-02)
