...
> 📎 **속편 — 네이티브 편입 에픽 cutover 마무리**: 본 가이드(MIG-1~11 원 이관) 이후, 2026 "이카운트 이관 자료 네이티브 편입" 에픽의 cutover 마무리(주문 네이티브 이식 실행 + "회계 관리자" silo 최종 폐기 + 중간테이블 물리 정리)는 [2026-06-20-ecount-native-fold-cutover-runbook.md](./2026-06-20-ecount-native-fold-cutover-runbook.md) 참조.
