 ...
 * (NoopPartnerLookupClient JavaDoc 참조). {@link Profile @Profile("!test")} 로 test profile 에서는
 * 비활성화되어 IT 가 {@code @MockBean AligoAddressBookClient} 로 격리할 수 있다
...
public class MockAligoAddressBookClient {
    ...
    public AligoAddressBookClient mockAligoAddressBookClient() {
