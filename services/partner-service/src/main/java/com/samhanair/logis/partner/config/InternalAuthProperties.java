...
/**
 * 내부 호출자 (slip-service / 운영 admin 도구) 가 partner-service 의 {@code /internal/**}
 ...
 * (chained-default 패턴, application.yml 참조).
 *
 * <p>prod 프로파일에서 dev 기본값 사용 시 {@link InternalTokenGuard} 가 부팅을 거부한다.
 */
@Data
