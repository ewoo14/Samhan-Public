 ...
 *
 * <p>2026-01-01 = 회사 운영 시작 fictitious epoch. 만료 비교 패턴 (예: {@code hireDate.isBefore(now)})
 * 부재 보장 — 시간 진행에 따른 테스트 회귀 발생 X. production 진입 시점에는 입사일 입력 의무 또는
 * 사용자 입력 화면 추가 (Phase 10 user-service 화면 슬라이스 시점 정식 처리).
 */
@Entity
@Getter
...
public class Employee extends BaseEntity {
     ...
     *
     * <p>입사일 미입력 시 의도된 placeholder. 만료 비교 패턴 부재 — 실 production 진입 시 입사일
     * 입력 의무 (또는 사용자 입력 화면 추가). 본 상수는 seed / dev fixture / 화면 default 표시
     * 용도이며, entity 의 {@code hireDate} 자체는 NotNull DB column 으로 입력 의무 보존.
     */
