    ...
    void 모든_시트의_6_7행_헤더와_8행_데이터를_읽고_창고_수량_품목명을_정제한다() throws Exception {
        byte[] xlsx = workbook(
                sheet("첫번째", List.of(
                        ...
                        row("1-duplicate","삼성창고","ABC GHP [옵션] (메모)","2","3.6","O-1"),
