...
public class ArologisDriverAppController {
    ...
    @RequirePermission(page = ArologisPageCodes.DRIVER, action = com.samhanair.logis.security.permission.PermissionAction.VIEW)
    ...
    @RequirePermission(page = ArologisPageCodes.DRIVER, action = com.samhanair.logis.security.permission.PermissionAction.CREATE)
