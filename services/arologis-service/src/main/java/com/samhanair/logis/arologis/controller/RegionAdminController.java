...
public class RegionAdminController {
    ...
    @GetMapping
    @RequirePermission(page = ArologisPageCodes.REGION, action = com.samhanair.logis.security.permission.PermissionAction.VIEW)
    ...
    @PostMapping
    @RequirePermission(page = ArologisPageCodes.REGION_MANAGE, action = com.samhanair.logis.security.permission.PermissionAction.CREATE)
    ...
    @PutMapping("/{id}")
    @RequirePermission(page = ArologisPageCodes.REGION_MANAGE, action = com.samhanair.logis.security.permission.PermissionAction.UPDATE)
    ...
    @DeleteMapping("/{id}")
    @RequirePermission(page = ArologisPageCodes.REGION_MANAGE, action = com.samhanair.logis.security.permission.PermissionAction.DELETE)
