-- V67__seed_accounting_bank_matching_page_permission.sql
-- H-1 입출금 매칭 쓰기 page-code: accounting.bank-matching.
--
...
SET can_view = TRUE,
    can_edit = TRUE,
    modified_at = NOW(),
    modified_by = 'v67-accounting-bank-matching';
...
JOIN group_page_permissions gpp
 ...
 AND gpp.page_code = 'accounting.bank-matching'
