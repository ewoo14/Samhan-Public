...
- [KST(Asia/Seoul) 전역 표준화](project_kst_timezone_standard.md) — 2026-06-14 개발책임자. 시스템 전역(DB 포함) KST 기준. 현재 전부 UTC. 배차 collab 머지 후 전담 PR. 접근=JVM -Duser.timezone + postgres TZ + Hibernate/Jackson KST
